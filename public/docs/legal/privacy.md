...
## 2. Brukergenererte data og privatliv
...
## 4. Datasikkerhet og lagring

* Passord lagres i kryptert form via vår .NET Identity-backend.
* Kommunikasjon mellom din nettleser og våre servere er kryptert med standard SSL/TLS-kryptering.
* Dataene lagres trygt på våre servere i henhold til gjeldende GDPR-regelverk.
